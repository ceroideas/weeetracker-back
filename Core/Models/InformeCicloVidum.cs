...
{
    public partial class InformeCicloVidum
    {
        ...
        public string RaeeGestorCcaa { get; set; }
        public string RaeeGestorProv { get; set; }
        public string RaeeGestorMunicipio { get; set; }
